...
//      TODO (7) Display the weather icon using mDetailBinding
        mDetailBinding.compPrimaryWeatherInfo.imageView.setImageResource(SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(data.getInt(INDEX_WEATHER_CONDITION_ID)));
...
//        mDateView.setText(dateText);
        mDetailBinding.compPrimaryWeatherInfo.date.setText(dateText);
...
//        mDescriptionView.setText(description);
        mDetailBinding.compPrimaryWeatherInfo.weatherDescription.setText(description);
        mDetailBinding.compPrimaryWeatherInfo.weatherDescription.setContentDescription(descriptionA11y);

//      TODO (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.compPrimaryWeatherInfo.imageView.setContentDescription(descriptionA11y);
...
//        mHighTemperatureView.setText(highString);
        mDetailBinding.compPrimaryWeatherInfo.highTemperature.setText(highString);
        mDetailBinding.compPrimaryWeatherInfo.highTemperature.setContentDescription(highStringA11y);
...
//        mLowTemperatureView.setText(lowString);
        mDetailBinding.compPrimaryWeatherInfo.lowTemperature.setText(lowString);
        mDetailBinding.compPrimaryWeatherInfo.lowTemperature.setContentDescription(lowStringA11y);
...
//      TODO (20) Create the content description for the humidity for a11y
        String humidityStringA11y = getString(R.string.a11y_humidity,highString);
...
//        mHumidityView.setText(humidityString);
        mDetailBinding.compExtraWeatherInfo.humidity.setText(humidityString);
        mDetailBinding.compExtraWeatherInfo.humidity.setContentDescription(humidityStringA11y);

//      TODO (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.compExtraWeatherInfo.humidityLabel.setContentDescription(humidityStringA11y);
...
//      TODO (13) Use mDetailBinding to display the wind andr set the content description
        /* Set the text to display wind information */
//        mWindView.setText(windString);
        mDetailBinding.compExtraWeatherInfo.wind.setText(windString);
        mDetailBinding.compExtraWeatherInfo.wind.setContentDescription(windStringA11y);

//      TODO (22) Set the content description of the wind label to the wind a11y String
        mDetailBinding.compExtraWeatherInfo.windLabel.setContentDescription(windStringA11y);
