...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final String BUNDLE_KEY__LOCATION = "BUNDLE_KEY__LOCATION";
    private static final int LOADER_ID__WEATHER_DATA = 2343;
     ...
     */
    private void loadWeatherData(boolean forceInit) {
        showWeatherDataView();

        String location = SunshinePreferences.getPreferredWeatherLocation(this);
        Bundle queryBundle = new Bundle();
        queryBundle.putString(BUNDLE_KEY__LOCATION,location);
        LoaderManager loaderManager = getSupportLoaderManager();
        Loader<String> loader = loaderManager.getLoader(LOADER_ID__WEATHER_DATA);
        if (forceInit || loader == null) {
            loaderManager.initLoader(LOADER_ID__WEATHER_DATA,queryBundle,this);
        } else {
            loaderManager.restartLoader(LOADER_ID__WEATHER_DATA,queryBundle,this);
        }
    }
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        ...
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                String location  = args.getString(BUNDLE_KEY__LOCATION);
